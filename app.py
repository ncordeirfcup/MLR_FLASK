...
def corr_plot(X_train):
    ...
    annot_settings = {
    'fontweight': 'bold'}
    dataplot = sb.heatmap(pd.DataFrame(X_train).corr(), cmap="YlGnBu", annot=True, mask=mask,annot_kws=annot_settings)
...
def data():
    if request.method == 'POST':
       ...
       return render_template('data.html', r2=r2,r2adj=r2adj, q2loo=q2loo,mae=mae,mse=mse,
              ...
              tssize=nts.shape[0], mc=mc,tbl=tbl.to_html(),eq=eq,q2lmo=q2lmo)
